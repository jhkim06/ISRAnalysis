...
ISR2016Legacy = {
    ...
    'DY'       : isrSample('DYtoEE' ,       myinputDir_2016Legacy + 'DY/DYJetsToLL_M-50.root', isMC = True, isSig = True, isInc = True),
    'DY10to50' : isrSample('DYtoEE10to50' , myinputDir_2016Legacy + 'DY/DYJetsToLL_M-10to50.root', isMC = True, isSig = True, isInc = True),
